...
assert c.expect("There are total 2 commands in history")==0, "Unexpected output"
...
# should get expected result
assert c.expect("History is clear")==0, "Unexpected output"

# run var command
c.sendline("history")

# should get expected result
assert c.expect("There are total 0 commands in history")==0, "Unexpected output"
